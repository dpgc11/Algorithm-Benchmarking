...
public class SortingAlgos {
	...
	public static void bubbleSort(int[] array) {
		...
		System.out.println("Array sorted using bubble sort in: " + totalTime + " ms");
	}
	...
	public static void quickSortHelper(int[] array)
    {
        ...
        long totalTime = System.currentTimeMillis() - startTime;
		System.out.println("Array sorted using quick sort in: " + totalTime + " ms");
    }
	...
	public static void selectionSort(int[] array) {
		...
		long totalTime = System.currentTimeMillis() - startTime;
		System.out.println("Array sorted using selection sort in: " + totalTime + " ms");
	}
	...
	public static void insertionSort(int[] array) {
		...
		long totalTime = System.currentTimeMillis() - startTime;
		System.out.println("Array sorted using insertion sort in: " + totalTime + " ms");
	}
	...
	public static void mergeSortHelper(int[] array)
    {
        ...
        mergeSort(array);
        long totalTime = System.currentTimeMillis() - startTime;
		System.out.println("Array sorted using merge sort in: " + totalTime + " ms");
    }
